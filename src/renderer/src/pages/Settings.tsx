...
export default function Settings(): JSX.Element {
  ...
  return (
    <DrawerComponent title="Configurações">
      ...
      <Typography variant="body1">Informações sobre a ativação</Typography>
      <Typography variant="body1">
        Ativado para {user?.nome}(<a href={`mailto:${user?.email}`}>{user?.email}</a>) Válido até
        dia{' '}
        <span
          style={
      ...
      <Box sx={{ mt: 4 }}>
        <Typography variant="h6">Tempos de espera</Typography>
        ...
        <form onSubmit={formik.handleSubmit}>
          ...
          <Button type="submit" sx={{ width: '100%', mt: 4, mb: 4 }} variant="contained">
            Salvar
          </Button>
        </form>
      </Box>

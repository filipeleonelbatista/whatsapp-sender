...
export default function Onboarding(): JSX.Element {
  ...
  const handleSubmitForm = async (formValues: object): Promise<void> => {
    ...
    try {
      ...
      const request = await window.api.sendMessage(contact, message, [], config)
  ...
  React.useEffect(() => {
    ...
    if (localStorage.getItem('@config') !== null) {
      ...
      formikConfig.setFieldValue(
        'new_whatsapp_send_button',
        config.new_whatsapp_send_button ?? false
      )
    } else {
      const config = {
        start: 5000,
      ...
      component: (
        ...
        >
          ...
          <Typography variant="caption" lineHeight={1} textAlign="left">
            Vamos começar com esta etapa de configuração do app, caso queira pular esta etapa e ir
            direto ao aplicativo pode clicar no botão a baixo para prosseguir.
          </Typography>
          ...
          <Button variant="contained" onClick={handleNext} sx={{ marginTop: 2 }} fullWidth>
            Próximo
          </Button>
    ...
    },
    {
      ...
      component: (
        ...
        >
          ...
          <Button variant="outlined" onClick={handlePrevious} sx={{ marginTop: 2 }} fullWidth>
            Voltar
          </Button>
        </Box>
      )
    ...
    },
    {
      ...
      component: (
        ...
        >
          ...
          <Typography variant="caption" lineHeight={1} textAlign="left">
            Agora vamos configurar o ambiente. Esse passo pode ser muito complexo. Lembre-se de que
            se precisar de ajuda pode chamar a qualquer momento.
          </Typography>
    ...
    },
    {
      ...
      component: (
        ...
        >
          ...
          <Typography variant="caption" lineHeight={1} textAlign="left">
            Estamos configurando o ambiente. Esse passo pode ser muito complexo. Lembre-se de que se
            precisar de ajuda pode chamar a qualquer momento.
          </Typography>
      ...
      component: (
        ...
        >
          ...
          <Typography variant="body2" textAlign="center" mt={2} mb={4}>
            Agora caso não tenha enviado a mensagem, verifique os intervalos de tempo entre as ações
            do app. e clique em voltar a baixo para testar o envio novamente.
          </Typography>
    ...
    },
    {
      ...
      component: (
        ...
        >
          ...
          <Typography variant="body2" textAlign="center" mt={2} mb={4}>
            Aproveite o envio automatizado de mensagens e acelere seu negócio! E lembre, sempre que
            precisar pode chamar no nosso whatsapp.
          </Typography>

          <Button variant="contained" onClick={finishConfig} sx={{ marginTop: 2 }} fullWidth>

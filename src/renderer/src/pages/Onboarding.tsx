...
export default function Onboarding() {
  ...
  const handleSubmitForm = async (formValues: any) => {
    ...
    try {
      ...
      const request = await window.electron.sendMessage(contact, message, [], config)
  ...
  const steps = [
    {
      ...
      component: (
        <Box sx={{
          ...
          <Typography variant="h5" mb={2}>Que bom ter você aqui</Typography>
          <Typography variant="caption" lineHeight={1} textAlign="left">
            Vamos começar com esta etapa de configuração do app,
            caso queira pular esta etapa e ir direto ao aplicativo
            pode clicar no botão a baixo para prosseguir.
          </Typography>
          <Typography variant="h5" my={2}>Para prosseguir certifique-se que:</Typography>
          <List dense={true}>
            <ListItem>
              <ListItemIcon>
                <CheckmarkIcon color="primary" />
              </ListItemIcon>
              <ListItemText secondary={"Tenha o Navegador Google Chrome Instalado"} />
            </ListItem>
            <ListItem>
              <ListItemIcon>
                <CheckmarkIcon color="primary" />
              </ListItemIcon>
              <ListItemText secondary={"Tenha o WhatsApp instalado no smartphone"} />
            </ListItem>
            <ListItem>
              <ListItemIcon>
                <CheckmarkIcon color="primary" />
          ...
          <Typography variant="body2" textAlign="center" mt={2}>
            Vamos te guiar por todo o processo e se precisar de ajuda pode nos chamar no WhatsApp
          </Typography>

          <Button variant="contained" onClick={handleNext} sx={{ marginTop: 2 }} fullWidth>Próximo</Button>
    ...
    },
    {
      ...
      component: (
        <Box sx={{
          ...
          <Typography variant="h5" mb={2}>Vamos começar</Typography>
          <Typography variant="caption" lineHeight={1} textAlign="left">
            Para iniciar basta instalar o Google Chrome
          </Typography>
          <Button component="a" href="https://www.google.pt/intl/pt-PT/chrome" variant="contained" sx={{ marginTop: 2 }} fullWidth>
    ...
    },
    {
      ...
      component: (
        <Box sx={{
          ...
          <Typography variant="h5" mb={2}>Instalando o driver</Typography>
          <Typography variant="caption" lineHeight={1} textAlign="left">
            O Proximo passo é instalar o Driver do Google Chrome que é encontrado no site a baixo:
          </Typography>
          <Button component="a" href="https://chromedriver.chromium.org/downloads" variant="contained" sx={{ marginTop: 2 }} fullWidth>
    ...
    },
    {
      ...
      component: (
        <Box sx={{
          ...
          <Typography variant="h5" mb={2}>Configurando o ambiente</Typography>
          <Typography variant="caption" lineHeight={1} textAlign="left">
            Agora vamos configurar o ambiente. Esse passo pode ser muito complexo.
            Lembre-se de que se precisar de ajuda pode chamar a qualquer momento.
          </Typography>
    ...
    },
    {
      ...
      component: (
        <Box sx={{
          ...
          <Typography variant="h5" mb={2}>Pronto</Typography>
          <Typography variant="caption" lineHeight={1} textAlign="left">
            Talvez seja necessário reiniciar o computador. Mas antes vamos fazer um teste.
          </Typography>
          ...
          <Typography variant="body2" textAlign="center" mt={2} mb={2}>
            Confirme se a mensagem foi enviada. Se tudo estiver correto vamos prosseguir.
          </Typography>
      ...
      component: (
        <Box sx={{
          ...
          <Typography variant="body2" textAlign="center" mt={2} mb={4}>
            ...
            tempo entre as ações do app. e clique em voltar a baixo para testar o envio novamente.
          </Typography>

          <Box component="form" onSubmit={formikConfig.handleSubmit} sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
            <TextField
              fullWidth
              type="number"
              sx={{ mb: 1 }}
    ...
    },
    {
      ...
      component: (
        <Box sx={{
          ...
          <Typography variant="h5" mb={2}>Pronto</Typography>
          <Typography variant="body2" textAlign="center" mt={2} mb={4}>
            Aproveite o envio automatizado de mensagens e acelere seu negócio!
            E lembre, sempre que precisar pode chamar no nosso whatsapp.
          </Typography>

          <Button variant="contained" onClick={finishConfig} sx={{ marginTop: 2 }} fullWidth>Finalizar Configuração</Button>
          <Button variant="outlined" onClick={handlePrevious} sx={{ marginTop: 2 }} fullWidth>Voltar</Button>
        </Box>
      )
    }
      ...
      <Box sx={{
        ...
        <Box sx={{ zIndex: 10, position: 'absolute', top: 0, width: '100%' }}>
          <Box sx={{ mt: 8, display: 'flex', alignItems: 'center', gap: 2, flexDirection: 'column' }}>
            ...
            <Button variant="text" onClick={finishConfig}>Pular</Button>
          </Box>
        </Box>
      </Box >
    </ThemeProvider >

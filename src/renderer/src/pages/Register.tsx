...
export default function Register(): JSX.Element {
  ...
  const handleSubmitForm = async (formValues): Promise<void> => {
    ...
    try {
      ...
      const { nome, email, senha, selected_plan, request_access_date, payment_date, is_active } =
        data
      ...
      >
        <Box sx={style}>
          ...
          <Box sx={{ height: 'auto', width: '100%', mt: 2, mb: 2 }}>
            <QRCode style={{ height: 'auto', maxWidth: '100%', width: '100%' }} value={QrCode} />
          </Box>

          <Button fullWidth onClick={handleInformPayment} variant="contained" color="primary">
          ...
          >
            ...
            <Card sx={{ p: 2, mb: 8, maxWidth: 400, width: '100%' }}>
              <form
                ...
                style={{ width: '100%', display: 'flex', gap: '16px', flexDirection: 'column' }}
              >
                ...
                <Typography variant="body2" sx={{ w: '100%', textAlign: 'center' }}>
                  Para continuar basta realizar o cadastro e efetuar o pagamento. Em seguida basta
                  informar o pagamento clicando no botão a baixo.
                </Typography>
                <TextField
                  fullWidth
                  label="Nome"
